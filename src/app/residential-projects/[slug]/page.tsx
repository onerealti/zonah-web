...
const SVG: Record<string, string> = {
  ...
  spa: `<circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32 1.41 1.41M2 12h2m16 0h2M4.93 19.07l1.41-1.41M18.36 5.64l1.41-1.41"/>`,
  tennis: `<circle cx="12" cy="12" r="10"/><path d="M6.3 12c0-4 3.4-7.5 7.5-8"/><path d="M17.7 12c0 4-3.4 7.5-7.5 8"/>`,
  rain: `<path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/>`,
  games: `<rect x="2" y="6" width="20" height="12" rx="2"/><path d="M6 12h4m-2-2v4"/><circle cx="16" cy="11" r="1"/><circle cx="18" cy="13" r="1"/>`,
...
function getAmenityPath(label: string): string {
  const l = label.toLowerCase();
  if (l.includes('pool') || l.includes('swim')) return SVG.pool;
  if (l.includes('gym') || l.includes('fitness')) return SVG.gym;
  if (l.includes('club') || l.includes('hall')) return SVG.club;
  if (l.includes('play') || l.includes('child') || l.includes('kid') || l.includes('adventure')) return SVG.play;
  if (l.includes('secur') || l.includes('cctv') || l.includes('concierge')) return SVG.security;
  if (l.includes('ev') || l.includes('electr') || l.includes('charg')) return SVG.ev;
  if (l.includes('garden') || l.includes('landscap') || l.includes('jogg') || l.includes('trail') || l.includes('park')) return SVG.garden;
  if (l.includes('spa') || l.includes('wellness') || l.includes('meditat') || l.includes('yoga')) return SVG.spa;
  if (l.includes('tennis') || l.includes('squash') || l.includes('sport') || l.includes('court') || l.includes('badmin')) return SVG.tennis;
  if (l.includes('rain') || l.includes('water') || l.includes('stp') || l.includes('harvest')) return SVG.rain;
  if (l.includes('game') || l.includes('billiard') || l.includes('table tennis') || l.includes('indoor')) return SVG.games;
  if (l.includes('bbq') || l.includes('rooftop') || l.includes('amphit') || l.includes('lounge') || l.includes('deck')) return SVG.bbq;
  return SVG.default;
}
...
const PROJECTS: Record<string, Project> = {
  'noble-apartments': {
    name: 'Noble Apartments', location: 'Ameerpet DK Road, Hyderabad', city: 'Hyderabad',
    price: 'Price on Request', bhk: '2, 3 BHK', status: 'Completed', statusClass: 'ready-to-move',
    area: 'N/A', totalUnits: '20 Units', developmentSize: 'N/A',
    type: 'Luxury Apartments', possession: 'Ready', rera: 'N/A',
    ...
    amenities: [
      { label: '24x7 Security', svgPath: SVG.security },
      { label: 'Power Backup', svgPath: SVG.default },
      { label: 'Elevators', svgPath: SVG.default },
      { label: 'Premium Finishes', svgPath: SVG.default },
    ],
    floorPlans: [
  ...
  'fort-view': {
    name: 'Fort View', location: 'Road No.12 Banjara Hills, MLA colony', city: 'Hyderabad',
    price: 'Price on Request', bhk: '3, 4 BHK', status: 'Completed', statusClass: 'ready-to-move',
    area: 'N/A', totalUnits: '8 Units', developmentSize: '1000 sq yds',
    type: 'Super Luxury Apartments', possession: 'Ready', rera: 'N/A',
    ...
    amenities: [
      { label: 'Swimming Pool', svgPath: SVG.pool },
      { label: 'Gymnasium', svgPath: SVG.gym },
      { label: '24x7 Security', svgPath: SVG.security },
      { label: 'Reserved Parking', svgPath: SVG.default },
      { label: 'Air Conditioned', svgPath: SVG.default },
    ],
    floorPlans: [
  ...
  'pristine-homes': {
    name: 'Pristine Homes', location: 'Aziz Nagar, Hyderabad', city: 'Hyderabad',
    price: 'Price on Request', bhk: '3 BHK Triplex', status: 'Completed', statusClass: 'ready-to-move',
    area: '3700 sq.ft.', totalUnits: '6 Units', developmentSize: 'N/A',
    type: 'Triplex Villas', possession: 'Ready', rera: 'N/A',
    ...
    amenities: [
      { label: 'Children\'s Play Area', svgPath: SVG.play },
      { label: 'Landscaped Garden', svgPath: SVG.garden },
      { label: '24x7 Security', svgPath: SVG.security },
      { label: 'Triplex Design', svgPath: SVG.default },
    ],
    floorPlans: [
  ...
  'zonah-pine-villas': {
    name: 'Zonah Pine Villas', location: 'Aziznagar, Hyderabad', city: 'Hyderabad',
    price: 'Price on Request', bhk: '3 BHK Villas', status: 'Ongoing', statusClass: 'under-construction',
    area: 'N/A', totalUnits: 'N/A', developmentSize: 'N/A',
    type: 'Residential Project', possession: 'TBA', rera: 'TBA',
  ...
  'tree-tops': {
    name: 'Tree Tops', location: 'Road No. 4, Banjara Hills, Hyderabad', city: 'Hyderabad',
    price: 'Price on Request', bhk: '3 BHK', status: 'Completed', statusClass: 'ready-to-move',
    area: 'N/A', totalUnits: 'N/A', developmentSize: 'N/A',
    type: 'Luxury Apartments', possession: 'Ready', rera: 'N/A',
    ...
    amenities: [
      { label: 'Swimming Pool', svgPath: SVG.pool },
      { label: 'Gymnasium', svgPath: SVG.gym },
      { label: 'Rooftop Lounge', svgPath: SVG.bbq },
      { label: '24x7 Security', svgPath: SVG.security },
      { label: 'Elevators', svgPath: SVG.default },
    ],
    floorPlans: [
...
export default function ResidentialProjectDetail({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <main className="home-page-replica">
        <section className="section section-inner-page pt-6">
          <div className="container has-text-centered py-6">
            ...
            <Link href="/residential-projects" className="theme-btn" style={{ display: 'inline-block' }}>
...
function ProjectDetailUI({ project }: { project: Project }) {
  ...
  const sectionIds = ['project-about', 'project-plans', 'project-amenities', 'project-location'];
        ...
        <div className="container">
          ...
          <div className="columns is-variable is-6 is-multiline">
            ...
            <div className="column project-inner-page-col is-12-mobile is-12-tablet is-7-desktop">
              ...
              {/* Breadcrumb */}
              <div className="mb-4">
                <Link href="/residential-projects" style={{ textDecoration: 'none', fontSize: '0.88em', color: '#856d47' }}>
              ...
              {/* Anchor nav — exact source structure */}
              ...
              <div id="project-about" className="projects-sub-section mb-5 project-about hide_about">
                ...
                {/* Key stats — source uses project-configurations style */}
              ...
              <div id="project-plans" className="projects-sub-section mb-5 project-plans hide_plans">
                ...
                {/* Tab filter — source uses .tabs-detail.rounded-tabs */}
              ...
              {/* ── AMENITIES — exact source structure ── */}
              ...
              <div id="project-location" className="projects-sub-section mb-5 hide_location">
                ...
                <div id="map" style={{
                  ...
                  {/* Grayscale map placeholder matching source */}
            ...
            <div className="column project-inner-page-col is-12-mobile is-12-tablet is-5-desktop">
              <div className="project-details-sidebar sticky-sidebar" style={{ position: 'sticky', top: 88 }}>
                <div className="theme-sidebar-card" style={{ border: '1px solid #e8e8e8', borderRadius: 6, overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
                  ...
                  {/* Stats grid — exact source: 2×2 with icons */}
                  ...
                  {/* Action buttons: Download Brochure + call + map */}
                  ...
                  {/* REQUEST A CALLBACK form — exact source structure */}
