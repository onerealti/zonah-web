...
export default function FAQ() {
    return (
        <main className="home-page-replica faq-page" dangerouslySetInnerHTML={{
            __html: `
...
</script>    <section class="section section-faq-inner-page section-inner-page pt-6">
    <div class="container faq-wrapper">
        <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled">
            <h1 class="text-primary">FAQs</h1>
        </div>
        <div class="columns is-multiline faqs-category-cols append-faqcategories">

            <div class="column is-12-mobile is-12-tablet is-6-desktop is-6-widescreen faq-category-col">
              <div class="faq-category-block">
                <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled mb-4">
                  <h3 class="text-primary">Home Buying Process</h3>
                </div>
                <div class="accordian faq-accordian">
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>How do I book a flat with Zonah Developers?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Booking a flat with Zonah Developers is simple. You can visit any of our Experience Centres, browse projects on our website, or speak with our sales advisors. Once you have chosen a unit, you'll need to fill out a booking form and pay the initial booking amount. Our team will then guide you through the documentation and payment process.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Can I visit the project site before booking?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Yes, absolutely. We encourage all prospective buyers to visit our project sites and Experience Centres to get a first-hand view of the layouts, amenities, and the surrounding area. Our sales team will arrange a guided site visit at a time convenient for you.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>What documents do I need to provide at the time of booking?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>At the time of booking you typically need to provide: a copy of your PAN card, address proof (Aadhaar, Passport, or Driving Licence), passport-size photographs, and a cancelled cheque for bank details. For NRI buyers, a copy of the passport and relevant visa/OCI documents are also required.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>How long does it take to get possession of my flat?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>The possession timeline varies by project and is clearly mentioned in the Sale Agreement. Zonah Developers strives to deliver on or ahead of schedule. Each project's expected possession date is available on the respective project page on our website.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="column is-12-mobile is-12-tablet is-6-desktop is-6-widescreen faq-category-col">
              <div class="faq-category-block">
                <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled mb-4">
                  <h3 class="text-primary">Financing &amp; Payment Plans</h3>
                </div>
                <div class="accordian faq-accordian">
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>What payment plans are available?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Zonah Developers offers flexible payment plans to suit varied financial needs. These include construction-linked plans (CLP), time-linked plans, and subvention schemes in select projects. Details of available payment plans are project-specific; please contact our sales team for the most current options.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Do you have tie-ups with banks for home loans?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Yes. Zonah Developers has tie-ups with several leading public and private sector banks including SBI, HDFC, ICICI, Axis Bank, and Kotak Mahindra Bank for home loan financing. Our loan liaison team can assist you in choosing the right bank and getting pre-approval before you book.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Can NRIs invest in Zonah Developers projects?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Yes, NRIs can invest in Zonah Developers' residential and commercial projects subject to FEMA guidelines. NRIs can make payments through their NRE / NRO bank accounts. Our dedicated NRI desk is available to guide you through the documentation and bank transfer process seamlessly.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="column is-12-mobile is-12-tablet is-6-desktop is-6-widescreen faq-category-col">
              <div class="faq-category-block">
                <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled mb-4">
                  <h3 class="text-primary">Project Features &amp; Amenities</h3>
                </div>
                <div class="accordian faq-accordian">
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>What amenities are typically provided in Zonah Developers projects?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Our residential projects are equipped with world-class amenities such as a landscaped clubhouse, swimming pool, gymnasium, jogging track, children's play area, multi-purpose hall, indoor games room, meditation deck, and 24/7 security with video surveillance. Exact amenities vary by project.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Are the projects RERA-registered?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Yes. All Zonah Developers projects are duly registered under the Real Estate Regulatory Authority (RERA) of the respective state. RERA registration numbers for each project are available on our website and can also be verified on the respective state RERA portal.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Does Zonah Developers offer any green building features?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Yes. Sustainability is integral to our design philosophy. Zonah Developers incorporates green building practices such as rainwater harvesting, sewage treatment plants, solar-powered common areas, EV charging points, and energy-efficient fixtures. Several projects are IGBC or LEED pre-certified.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="column is-12-mobile is-12-tablet is-6-desktop is-6-widescreen faq-category-col">
              <div class="faq-category-block">
                <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled mb-4">
                  <h3 class="text-primary">Legal &amp; Documentation</h3>
                </div>
                <div class="accordian faq-accordian">
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>What is the process for property registration?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Property registration is done at the local Sub-Registrar's office and is typically carried out at the time of possession. Zonah Developers assists buyers through the registration process, helping you prepare the required documents including the Sale Deed, identity proofs, and encumbrance certificate.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>What are the taxes and charges applicable on purchase?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>In addition to the base price, buyers are required to pay GST (currently 5% for under-construction properties), stamp duty (varies by state, typically 5–7%), and registration charges. Maintenance deposits and other one-time charges may also apply as outlined in the Sale Agreement.</p>
                    </div>
                  </div>
                  <div class="accordian_item">
                    <div class="accordian_title is-flex is-justify-content-space-between is-align-items-center">
                      <h4>Can I change the name during or after booking?</h4>
                      <span class="faq-icon">+</span>
                    </div>
                    <div class="accordian_desc" style="display: none;">
                      <p>Name addition or transfer is subject to Zonah Developers' policies and may attract nominal administrative charges. Name changes are generally permitted before possession with the requisite documentation. Please contact our customer support team for specific cases and timelines.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="related-articles hide-relateddata">
            <div class="section-title section-title-with-arrow js-scroll fade-in-top scrolled">
                <h2 class="text-primary">Latest Blogs</h2>
            </div>
            <div id="related-articles-slider" class="splide js-scroll fade-in-bottom">
                <div class="splide__track">
                    <ul class="splide__list append_relatedarticles">
