                ...
                <div className="columns is-multiline is-vcentered about-us-cols gap-5">
                    ...
                    <div className="column is-12-mobile is-12-tablet is-7-desktop is-7-widescreen about-us-col">
                        <ScrollReveal direction="up" distance={30} delay={0.1} className="about-us-detail">
                            ...
                            <p className="mb-4">
                                With a diverse portfolio spanning residential, commercial, and land development segments, Zonah has delivered landmark projects that redefine communities across major Indian cities — from Bangalore and Hyderabad to Chennai and Mumbai.
                            </p>
